...
NS_LOG_COMPONENT_DEFINE ("SaqrPacket");

namespace saqr {

NS_OBJECT_ENSURE_REGISTERED(TypeHeader);

TypeHeader::TypeHeader(MessageType t = SAQRTYPE_HELLO)
  : m_type(t),
    m_valid(true)
{
}
...
{
  static TypeId tid = TypeId("ns3::saqr::TypeHeader")
    .SetParent<Header>()
    .SetGroupName("SAQR")
...
{
  static TypeId tid = TypeId("ns3::saqr::HelloHeader")
    .SetParent<Header>()
    .SetGroupName("SAQR")
