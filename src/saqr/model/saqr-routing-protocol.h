#ifndef SAQR_ROUTING_PROTOCOL_H
#define SAQR_ROUTING_PROTOCOL_H

#pragma once

#include "saqr-packet.h"
#include "saqr-rtable.h"
...
public:
  ...
  static const uint32_t SAQR_PORT;
  ...
  void RecvSaqr (Ptr<Socket> socket);
