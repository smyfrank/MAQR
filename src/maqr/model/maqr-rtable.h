#ifndef MAQR_RTABLE_H
#define MAQR_RTABLE_H
...
public:
   ...
   */
  void SetExpiryTime (Time expiryTime)
  {
...
private:
  Time m_expiryTime; // Expiration time of the route
  /** Ip route, include
   *   - destination address
   *   - source address
...
/**
 * \ingroup maqr
 * \brief The Routing table used by MAQR protocol
 */
class RoutingTable
{
public:
